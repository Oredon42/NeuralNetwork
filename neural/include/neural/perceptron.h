...
public:
    ...
    // Getters
	__forceinline size_t numberOfInputs() const{return m_aWeights.size();}
	__forceinline real learningRate() const{return m_rLearningRate;}
	__forceinline real bias() const{return m_rBias;}
